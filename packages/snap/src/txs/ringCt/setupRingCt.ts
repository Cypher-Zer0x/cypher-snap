...
import { getLocalUtxos, saveUtxos } from "../../utils/utxoDB";
...
export async function setupRingCt(
  ...
  //   output_index: 0,
  //   public_key: (new Curve(CurveName.SECP256K1)).GtoPoint().mult(123n).compress(), // public key of the owner of the utxo
  //   amount: maskAmount(G.mult(BigInt("0xa77a293237ea6d1539f1608665fe0b7135115e4acc6ffeafa56e676dac88ce6d")), 123n, 12345n), // encrypted amount + blinding factor, only the owner can decrypt it (if coinbase, the amount is clear and there is no blinding factor)
